@{
    ...
    @(
        @{ 
            ...
            DomainJoinPassword = 'Tr@ining123'             
            LocalAdminPassword = 'Tr@ining123'                  
            ...
            NCClusterUsername = 'COMPANY\administrator'        
            NCClusterPassword = 'Tr@ining123'  
            ...
            HostUsername = 'COMPANY\administrator'                
            HostPassword = 'Tr@ining123'     
